...
define("compiler", ["require", "exports"], function (require, exports) {
    ...
    var Compiler = /** @class */ (function () {
        ...
        Compiler.prototype.compileMessage = function (ast) {
            ...
            var pattern = elements.filter(function (el) { return el.type === "messageTextElement" || el.type === "argumentElement"; });
        ...
        Compiler.prototype.compileArgument = function (element) {
            ...
            var formats = this.formats, locales = this.locales, options;
            switch (format.type) {
                case "numberFormat":
                ...
                case "pluralFormat":
                    ...
                    return new PluralFormat(element.id, format.ordinal, format.offset, options, locales);
                case "selectFormat":
                    options = this.compileOptions(element);
    ...
    var PluralOffsetString = /** @class */ (function () {
